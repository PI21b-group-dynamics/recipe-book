namespace recipe_book
{
	partial class EditProfileForm
	{
		...
		private void InitializeComponent()
		{
			...
			tableLayoutPanel1.Controls.Add(txtEmail, 0, 3);
			tableLayoutPanel1.Controls.Add(txtLogin, 0, 2);
			...
			tableLayoutPanel1.RowStyles.Add(new RowStyle());
			tableLayoutPanel1.RowStyles.Add(new RowStyle());
			tableLayoutPanel1.Size = new Size(311, 341);
			...
			txtPassword.Location = new Point(12, 222);
			...
			txtLogin.Location = new Point(12, 142);
			...
			btnCancel.Location = new Point(12, 265);
			...
			btnSave.Location = new Point(158, 265);
			...
			btnDeleteProfile.Location = new Point(9, 302);
			...
			picUser.Location = new Point(9, 16);
			picUser.Margin = new Padding(0, 8, 0, 8);
			picUser.Name = "picUser";
			picUser.Size = new Size(293, 95);
			...
			// linkLabel1
			// 
			tableLayoutPanel1.SetColumnSpan(linkLabel1, 2);
			linkLabel1.Dock = DockStyle.Fill;
			linkLabel1.Location = new Point(12, 119);
